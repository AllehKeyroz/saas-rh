...
export default function VidaFinanceira() {
  ...
  const { data: comissoesFuncionarios = [] } = useQuery({
    ...
    queryFn: () => client.entities.ComissaoPorFuncionario.filter({ funcionario_id: funcionario.id }),
    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="bg-sidebar text-sidebar-foreground px-4 py-3 flex items-center justify-between sticky top-0 z-20">
        ...
        <div className="flex items-center gap-2">
          ...
          <Button variant="ghost" size="icon" className="text-sidebar-foreground/70 hover:text-sidebar-foreground h-8 w-8" onClick={() => client.auth.logout()}>
