...
export default function MinhasMetas({ funcionarioId, salarioBase }) {
  ...
  const handleSalvarMeta = async () => {
    ...
    setSaving(true);
    if (metaMes) {
      await client.entities.MetaFinanceira.update(metaMes.id, { meta_mensal: v });
    } else {
      await client.entities.MetaFinanceira.create({ funcionario_id: funcionarioId, mes_referencia: mesSelecionado, meta_mensal: v });
    }
