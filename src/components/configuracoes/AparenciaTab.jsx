...
export default function AparenciaTab() {
  ...
  const { data: configs = [], isLoading } = useQuery({
    queryKey: ['aparencia'],
    queryFn: () => client.entities.ConfiguracaoAparencia.list(),
  });
  ...
  const handleSave = async () => {
    setSaving(true);
    if (existingId) {
      await client.entities.ConfiguracaoAparencia.update(existingId, form);
    } else {
      const novo = await client.entities.ConfiguracaoAparencia.create(form);
